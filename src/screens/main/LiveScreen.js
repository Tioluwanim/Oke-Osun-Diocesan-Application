    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.ytButton} onPress={openYouTubeChannel}>
          <Text style={styles.ytButtonIcon}>â–¶</Text>
        ...
        {['live', 'upcoming', 'past'].map((tab) => (
          ...
          >
            <Text style={[styles.tabText, activeTab === tab && styles.tabTextActive]}>
              {tab === 'live' ? 'ðŸ”´ Live' : tab === 'upcoming' ? 'ðŸ“… Upcoming' : 'ðŸŽ¬ Past'}
            </Text>
            ...
            {isLoading ? (
              ...
              <View>
                ...
                <View style={styles.streamInfo}>
                  <Text style={styles.streamTitle}>
                    {stream.title || 'Live Service â€” Diocese of Oke-Osun'}
                  </Text>
                  <View style={styles.streamMetaList}>
                    {stream.scheduledTime && <StreamMeta icon="â°" text={`Started at ${stream.scheduledTime}`} />}
                    {stream.description && <StreamMeta icon="ðŸ“" text={stream.description} />}
                  </View>
                  ...
                  <TouchableOpacity style={styles.shareBtn}>
                    <Text style={styles.shareBtnText}>â†—  Share Stream</Text>
                  </TouchableOpacity>
                </View>
              </View>
            ) : (
              <View style={styles.noLiveContainer}>
                <View style={styles.noLiveIcon}>
                  <Text style={styles.noLiveEmoji}>ðŸ“º</Text>
                </View>
                ...
                {stream?.scheduledDate && (
                  <View style={styles.scheduledCard}>
                    ...
                    <View style={styles.scheduledMeta}>
                      <StreamMeta icon="ðŸ“…" text={stream.scheduledDate} />
                      {stream.scheduledTime && <StreamMeta icon="â°" text={stream.scheduledTime} />}
                    </View>
                  </View>
                )}
                ...
                {stream?.youtubeUrl && (
                  <TouchableOpacity
                    ...
                    activeOpacity={0.85}
                  >
                    <Text style={styles.noLiveBtnText}>â–¶  Watch Previous Stream</Text>
                  </TouchableOpacity>
                )}
                ...
                <TouchableOpacity
                  ...
                  activeOpacity={0.85}
                >
                  <Text style={styles.noLiveBtn2Text}>ðŸ“…  View Upcoming Streams</Text>
                </TouchableOpacity>

                <TouchableOpacity style={styles.noLiveBtnOutline} onPress={openYouTubeChannel}>
                  <Text style={styles.noLiveBtnOutlineText}>â–¶  Visit YouTube Channel</Text>
                </TouchableOpacity>
              </View>
            )}
          </View>
          ...
          <View style={styles.listSection}>
            ...
            {isLoading ? (
              ...
              <View style={styles.upcomingCard}>
                ...
                >
                  <Text style={styles.remindBtnIcon}>ðŸ””</Text>
                </TouchableOpacity>
              </View>
            ) : (
            ...
            <View style={styles.notifyCta}>
              <Text style={styles.notifyCtaIcon}>ðŸ””</Text>
        ...
        {activeTab === 'past' && (
          <View style={styles.listSection}>
              ...
              >
                <View style={styles.pastThumbnail}>
                  <View style={styles.pastPlayBtn}>
                    <Text style={styles.pastPlayIcon}>â–¶</Text>
                  </View>
                </View>
                  ...
                  <View style={styles.pastMeta}>
                    {stream.updatedAt && (
                      <Text style={styles.pastMetaText}>
                        ðŸ“… {stream.updatedAt.slice(0, 10)}
                      </Text>
                    )}
                  </View>
                  <Text style={styles.pastWatchText}>Watch on YouTube â€º</Text>
                </View>
              </TouchableOpacity>
            ) : (
              <View style={styles.noScheduleCard}>
                <Text style={styles.noScheduleIcon}>ðŸŽ¬</Text>
            ...
            <TouchableOpacity style={styles.ytCta} onPress={openYouTubeChannel} activeOpacity={0.85}>
              <Text style={styles.ytCtaIcon}>â–¶</Text>
              <View>
              ...
              <Text style={styles.ytCtaArrow}>â€º</Text>
            </TouchableOpacity>
          </View>
        )}
...
const styles = StyleSheet.create({
  ...
  tabIndicator: { position: 'absolute', bottom: 0, left: SPACING.lg, right: SPACING.lg, height: 2, borderRadius: 1, backgroundColor: COLORS.gold },
  ...
  videoPlayer: { marginHorizontal: SPACING.lg, borderRadius: RADIUS.lg, overflow: 'hidden', marginBottom: SPACING.lg, borderWidth: 1, borderColor: 'rgba(201,76,76,0.3)' },
  ...
  noLiveIcon: { width: 100, height: 100, borderRadius: 50, backgroundColor: COLORS.surface, borderWidth: 1, borderColor: COLORS.border, justifyContent: 'center', alignItems: 'center', marginBottom: SPACING.sm },
  ...
  scheduledCard: { backgroundColor: COLORS.surface, borderWidth: 1, borderColor: 'rgba(201,168,76,0.3)', borderRadius: RADIUS.lg, padding: SPACING.md, width: '100%', gap: SPACING.sm },
  ...
  noScheduleCard: { backgroundColor: COLORS.surface, borderWidth: 1, borderColor: COLORS.border, borderRadius: RADIUS.lg, padding: SPACING.xl, alignItems: 'center', gap: SPACING.sm, marginBottom: SPACING.lg },
  ...
  pastCard: { backgroundColor: COLORS.surface, borderWidth: 1, borderColor: COLORS.border, borderRadius: RADIUS.lg, marginBottom: SPACING.md, flexDirection: 'row', gap: SPACING.md, padding: SPACING.md, alignItems: 'center' },
  ...
  ytCta: { flexDirection: 'row', alignItems: 'center', gap: SPACING.md, backgroundColor: 'rgba(201,76,76,0.08)', borderWidth: 1, borderColor: 'rgba(201,76,76,0.25)', borderRadius: RADIUS.lg, padding: SPACING.md, marginTop: SPACING.sm },

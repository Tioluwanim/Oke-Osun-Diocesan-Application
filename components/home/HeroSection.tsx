...
export default function HeroSection() {
  return (
    <section className="cinematic-hero relative isolate overflow-hidden bg-navy">
      <Image
      ...
      />
      <div className="hero-vignette absolute inset-0 -z-10 bg-gradient-to-b from-navy/70 via-navy/80 to-navy" />
      <div className="container-diocese flex min-h-[70vh] flex-col items-center justify-center gap-6 py-24 text-center">
        <p className="reveal reveal-visible text-sm font-semibold uppercase tracking-[0.2em] text-gold">
          Church of Nigeria — Anglican Communion
        </p>
        <h1 className="reveal reveal-visible text-white [animation-delay:80ms]">Diocese of Oke-Osun</h1>
        <p className="reveal reveal-visible max-w-2xl text-lg text-white/85 [animation-delay:160ms]">

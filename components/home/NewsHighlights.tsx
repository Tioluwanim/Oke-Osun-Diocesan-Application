...
const HOME_NEWS = [
  ...
  },
  {
    ...
    summary: 'Rooted in Christ: a three-day youth camp with worship, Bible teaching, leadership training, and fellowship.',
    href: '/events',
  },
  {
    id: 'home-women',
    ...
    summary: 'A joint gathering of the Diocese women organisations for biblical teaching, fellowship, worship, and service.',
    href: '/events',
  },
];

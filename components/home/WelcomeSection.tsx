    ...
    <section className="section bg-white">
      <div className="container-diocese">
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-2">
          <Reveal variant="scale" className="stat-card card flex gap-4 border-t-4 border-gold p-6">
            <div className="flex h-12 w-12 flex-none items-center justify-center rounded-full bg-navy text-xl text-gold" aria-hidden="true">
              🕊
            </div>
            <div>
              <h3 className="text-lg">Our Vision</h3>
              <p className="mt-2 text-base text-ink-muted">
                To build a virile Diocese that shall be growing light in the darkness of the world,
                shining brighter every day through the proclamation of the Gospel of our Lord Jesus
                Christ, winning souls for Christ and making them disciples fit for the Kingdom of
                God.
              </p>
            </div>
          </Reveal>
          <Reveal variant="scale" delay={120} className="stat-card card flex gap-4 border-t-4 border-gold p-6">
            <div className="flex h-12 w-12 flex-none items-center justify-center rounded-full bg-navy text-xl text-gold" aria-hidden="true">
              ✓
            </div>
            <div>
